...
public class SwordItemExtension extends SwordItem implements IFakeableItem {
    public Item fake;
    public String name;
    public SwordItemExtension(Tier tier, int i, float f, Properties properties, Item fake, String name) {
