...
public class AxeItemExtension extends AxeItem implements IFakeableItem {
    public Item fake;
    public String name;
    public AxeItemExtension(Tier tier, float f, float g, Properties properties, Item fake, String name) {
